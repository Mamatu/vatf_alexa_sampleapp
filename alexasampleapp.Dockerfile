...
#&& ENV HOME /home \
&& cd /home && git clone -b develop_20231130 --recurse-submodules https://github.com/Mamatu/vatf.git \
&& cd /home \
...
&& . /envfile \
&& cd /home/sdk-folder/sdk-build && cmake /home/sdk-folder/sdk-source/avs-device-sdk \
...
COPY sampleapp/alexa_config/config.json /home/sdk-folder/sdk-source/avs-device-sdk/tools/Install/config.json
